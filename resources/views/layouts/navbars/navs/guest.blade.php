            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href='/characters' class="nav-link text-primary">
                        <i class="tim-icons icon-minimal-left"></i> {{ __('Characters') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a href='/characters/create' class="nav-link text-primary">
                        <i class="tim-icons icon-minimal-left"></i> {{ __('Create Characters') }}
                    </a>
                </li>
                <li class="nav-item">
